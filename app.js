(function(){
  ...
  function routeIconBtn(item){
    ...
    return '<button class="poster-icon-btn" data-route-title="' + esc(item.title) + '" aria-label="' + esc(t('routeDetailsLabel')) + '" title="' + esc(t('routeDetailsLabel')) + '">' +
      '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="7" y1="21" x2="7" y2="3"></line><path d="M7 5h11l-3 3 3 3H7"></path><path d="M7 15H3l3-2.5L3 10h4"></path></svg>' +
    '</button>';
  }
