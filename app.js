(function(){
  ...
  var I18N = {
    de: {
      ...
      presentersAutoInfo: 'Hilfe beim Benennen: Geben Sie unten Ihren Nachnamen ein und wählen Sie den passenden Beitrag aus dem Dropdown-Menü aus. Sie erhalten daraufhin den fertigen Dateinamen für Ihre Präsentation, und der passende Upload-Link wird automatisch freigeschaltet.',
      ...
      presentersRenameInfo: 'Alternativ: Klicken Sie auf "Datei auswählen & umbenennen", um Ihre Datei automatisch umzubenennen. Es wird eine umbenannte Kopie lokal heruntergeladen, die Sie dann anschließend noch hochladen müssen, indem Sie auf "Zum Upload-Ordner" klicken.',
    ...
    en: {
      ...
      presentersAutoInfo: 'Help with naming: enter your surname below and select the matching contribution from the dropdown. You\'ll then get the finished file name for your presentation, and the matching upload link will unlock automatically.',
      ...
      presentersRenameInfo: 'Alternatively: click "Choose file & rename" to have your file renamed automatically. A renamed copy will be downloaded locally, which you then still need to upload by clicking "Go to upload folder".',
